...
class CfgVehicles
{
	...
	class Orxe_CarKeyCase : SmallProtectorCase
	{
		...
		hiddenSelectionsTextures[] = {"\CarKeyCase\data\item\textures\carkeycase_co.paa"};
	};

#include "variants\Orxe_CarKeyCase_Pink.hpp"
#include "variants\Orxe_CarKeyCase_Purple.hpp"
#include "variants\Orxe_CarKeyCase_Blue.hpp"
#include "variants\Orxe_CarKeyCase_Navy.hpp"
#include "variants\Orxe_CarKeyCase_Orange.hpp"
#include "variants\Orxe_CarKeyCase_Green.hpp"
};
